...
use crate::tantivy_file_indexer::shared::indexing_crawler::{models::crawler_file::CrawlerFile, traits::crawler_queue_api::CrawlerQueueApi};
/*
...
pub async fn create_busy_work<C>(queue:Arc<C>) -> Result<(),String> where C: CrawlerQueueApi{
