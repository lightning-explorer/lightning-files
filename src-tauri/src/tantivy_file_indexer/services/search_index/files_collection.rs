...
use super::engine::core::constructor::QueryConstructor;
...
impl FilesCollectionApi for TantivyFilesCollection {
    ...
    ) -> impl std::future::Future<Output = Result<std::collections::HashSet<String>, Self::Error>> + Send
    {
        ...
        async move {
            ...
            let query = self.constructor.construct_term_query("path", &dir_path_str).map_err(|err|err.to_string())?;
            queries.push(query);
    ...
    fn upsert_many(
        &self,
        models: &[crate::tantivy_file_indexer::models::internal_system_file::model::Model],
